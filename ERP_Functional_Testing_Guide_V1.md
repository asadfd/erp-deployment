...
2. Test URL: `https://erp-deployment-production.up.railway.app/login` (or provided test server URL)
...
# All FLOW(LIKE HR,EMPLOYEE,INVENTORY,PO,MRF)  HAS APPROVAL/REJECT FUNCTIONS TO BE APPROVED ONLY BY SUPERADMIN
...
4. Fill in the form:
   - Username: `admin or hr 0r pmo`
   - Password: `Test@1234 or any `
   - Confirm Password: `same as above`
   - Role: Select "PROJECT MANAGER or any what is needed"
...
**Test Steps**:
1. In User Management page, find `username you created add here`
2. Click "Edit" button
